"""Typeset the saved J1752 research manuscript; performs no scientific fits."""
...
SOURCE=FOLDER/'J1752-2806_Candidate_Report.md'
OUTPUT=FOLDER/'J1752-2806_Candidate_Report.pdf'
...
class PagedCanvas(canvas.Canvas):
    ...
    def save(self):
        ...
        for state in self.states:
            ...
            self.drawString(52,765,'PROJECT RECHERCHE  |  PSR J1752-2806')
            self.drawRightString(560,765,'Research report PR-J1752-2026-01')
...
for block in blocks:
    ...
    if b.startswith('|'):
        ...
        count=len(rows[0]);widths={2:[280,228],3:[248,130,130],4:[170,112,113,113],5:[190,76,76,76,90]}[count]
...
doc=SimpleDocTemplate(str(OUTPUT),pagesize=(612,792),rightMargin=52,leftMargin=52,topMargin=46,bottomMargin=48,title='A bounded focused noise and uncertainty review of PSR J1752-2806',author='Project Recherche',subject='Observed pulsar-timing candidate and bounded diagnostic review',pageCompression=1)

"""Typeset the saved J1453 research manuscript; performs no scientific fits."""
...
SOURCE=FOLDER/'J1453+1902_Candidate_Report.md'
OUTPUT=FOLDER/'J1453+1902_Candidate_Report.pdf'
...
def markup(text):
    text=escape(text)
    for char,value in zip('₀₁₂₃₄₅₆₇₈₉ₛᵢⱼ','0123456789sij'):
...
class PagedCanvas(canvas.Canvas):
    ...
    def save(self):
        ...
        for state in self.states:
            ...
            self.drawString(52,765,'PROJECT RECHERCHE  |  PSR J1453+1902')
            self.drawRightString(560,765,'Research report PR-J1453-2026-01')
            self.setStrokeColor(colors.HexColor('#999999'));self.setLineWidth(.35);self.line(52,758,560,758)
            self.drawString(52,29,'Version 1.0  |  8 September 2026')
...
for block in blocks:
    ...
    if b.startswith('|'):
        ...
        count=len(rows[0]);widths={2:[280,228],4:[230,60,112,106],5:[190,76,76,76,90]}[count]
...
doc=SimpleDocTemplate(str(OUTPUT),pagesize=(612,792),rightMargin=52,leftMargin=52,topMargin=46,bottomMargin=48,title='A noise-sensitive periodic timing candidate in PSR J1453+1902',author='Project Recherche',subject='Observed pulsar-timing candidate and bounded diagnostic review',pageCompression=1)
